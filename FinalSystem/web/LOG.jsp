...
<head>
	...
	<!-- Bootstrap -->
	<link href="JspPages/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
	<link href="JspPages/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
	
	<!-- Bootstrap Extended -->
	<link href="JspPages/bootstrap/extend/jasny-bootstrap/css/jasny-bootstrap.min.css" rel="stylesheet" />
	<link href="JspPages/bootstrap/extend/jasny-bootstrap/css/jasny-bootstrap-responsive.min.css" rel="stylesheet" />
	<link href="JspPages/bootstrap/extend/bootstrap-wysihtml5/css/bootstrap-wysihtml5-0.0.2.css" rel="stylesheet" />
	
	<!-- JQueryUI v1.9.2 -->
	<link rel="stylesheet" href="JspPages/theme/scripts/jquery-ui-1.9.2.custom/css/smoothness/jquery-ui-1.9.2.custom.min.css" />
	
	<!-- Glyphicons -->
	<link rel="stylesheet" href="JspPages/theme/css/glyphicons.css" />
	
	<!-- Bootstrap Extended -->
	<link rel="stylesheet" href="JspPages/bootstrap/extend/bootstrap-select/bootstrap-select.css" />
	<link rel="stylesheet" href="JspPages/bootstrap/extend/bootstrap-toggle-buttons/static/stylesheets/bootstrap-toggle-buttons.css" />
	
	<!-- Uniform -->
	<link rel="stylesheet" media="screen" href="JspPages/theme/scripts/pixelmatrix-uniform/css/uniform.default.css" />

	<!-- JQuery v1.8.2 -->
	<script src="JspPages/theme/scripts/jquery-1.8.2.min.js"></script>
	
	<!-- Modernizr -->
	<script src="JspPages/theme/scripts/modernizr.custom.76094.js"></script>
	
	<!-- MiniColors -->
	<link rel="stylesheet" media="screen" href="JspPages/theme/scripts/jquery-miniColors/jquery.miniColors.css" />
	
	<!-- Theme -->
	<link rel="stylesheet" href="JspPages/theme/css/style.min.css?1358876495" />
	
	
	
	<!-- LESS 2 CSS -->
	<script src="JspPages/theme/scripts/less-1.3.3.min.js"></script>
					...
					<!--<ul class="notif">
						...
						<li>
							<div class="btn-group">
								...
								<img src="JspPages/theme/images/lang/en.png" align="absmiddle" />
...
<span>Voters</span>
	...
	<!-- Cubiq iScroll -->
	<!--[if gte IE 9]><!-->
	<script src="JspPages/theme/scripts/cubiq-iscroll/src/iscroll.js"></script>
	...
	<!-- JQueryUI v1.9.2 -->
	<script src="JspPages/theme/scripts/jquery-ui-1.9.2.custom/js/jquery-ui-1.9.2.custom.min.js"></script>
	
	<!-- JQueryUI Touch Punch -->
	<!-- small hack that enables the use of touch events on sites using the jQuery UI user interface library -->
	<script src="JspPages/theme/scripts/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
	
	<!-- MiniColors -->
	<script src="JspPages/theme/scripts/jquery-miniColors/jquery.miniColors.js"></script>
	...
	<script src="JspPages/theme/scripts/jquery.cookie.js"></script>
	<script src="JspPages/theme/scripts/themer.js"></script>
	...
	<script src="JspPages/theme/scripts/flot/jquery.flot.js" type="text/javascript"></script>
	<script src="JspPages/theme/scripts/flot/jquery.flot.pie.js" type="text/javascript"></script>
	<script src="JspPages/theme/scripts/flot/jquery.flot.tooltip.js" type="text/javascript"></script>
	<script src="JspPages/theme/scripts/flot/jquery.flot.selection.js"></script>
	<script src="JspPages/theme/scripts/flot/jquery.flot.resize.js" type="text/javascript"></script>
	<script src="JspPages/theme/scripts/flot/jquery.flot.orderBars.js" type="text/javascript"></script>
	...
	<!-- Resize Script -->
	<script src="JspPages/theme/scripts/jquery.ba-resize.js"></script>
	
	<!-- Uniform -->
	<script src="JspPages/theme/scripts/pixelmatrix-uniform/jquery.uniform.min.js"></script>
	
	<!-- Bootstrap Script -->
	<script src="JspPages/bootstrap/js/bootstrap.min.js"></script>
	
	<!-- Bootstrap Extended -->
	<script src="JspPages/bootstrap/extend/bootstrap-select/bootstrap-select.js"></script>
	<script src="JspPages/bootstrap/extend/bootstrap-toggle-buttons/static/js/jquery.toggle.buttons.js"></script>
	<script src="JspPages/bootstrap/extend/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js"></script>
	<script src="JspPages/bootstrap/extend/jasny-bootstrap/js/jasny-bootstrap.min.js" type="text/javascript"></script>
	<script src="JspPages/bootstrap/extend/jasny-bootstrap/js/bootstrap-fileupload.js" type="text/javascript"></script>
	<script src="JspPages/bootstrap/extend/bootbox.js" type="text/javascript"></script>
	<script src="JspPages/bootstrap/extend/bootstrap-wysihtml5/js/wysihtml5-0.3.0_rc2.min.js" type="text/javascript"></script>
	<script src="JspPages/bootstrap/extend/bootstrap-wysihtml5/js/bootstrap-wysihtml5-0.0.2.js" type="text/javascript"></script>
	
	<!-- Custom Onload Script -->
	<script src="JspPages/theme/scripts/load.js"></script>
