...
public class SeatDetailsRpt extends Dbconnection {
    ...
    public boolean  CreateRepot(ResultSet reslts)  
    {
        ...
        try{
         ...
         PdfWriter.getInstance(doc, new FileOutputStream("C:/Users/User/Desktop/completedigrams/ClientReport.pdf"));
         doc.open();
         ...
         if (reslts.next())
                     {
                        ...
                        doc.add(table2);
                        Runtime.getRuntime().exec("rundll32 url.dll, FileProtocolHandler C:/Users/User/Desktop/completedigrams/ClientReport.pdf");
                        doc.close();
                        flage=true;
                     }
         return flage;
