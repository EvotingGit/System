<%@page import="Model.PrefernceDetailsRpt"%>
<%@page import="org.jfree.chart.ChartUtilities"%>
<%@page import="java.io.File"%>
<%@page import="org.jfree.chart.plot.PlotOrientation"%>
<%@page import="org.jfree.chart.ChartFactory"%>
<%@page import="Model.ChartDetails"%>
...
<!--[if gt IE 8]><!--> <html> <!--<![endif]-->
    ...
    <!-- This page expain the repor tha tuse full when checking
        the candidates which are registered with the perticular political Party --->
    <head>
        <title> Candidates Preference Amount Reports </title>
                                                ...
                                                <div class="rrow scroll-y" id="mainYScroller">
                                                    ...
                                                    <div class="middle_main">
                                                        ...
                                                        <div class="admin_register_wrapper">
                                                            <div class="reg_form_header"><h4>Candidates Preference Report </h4></div>

                                                            <form action="../GeneratecandidatePrefernceReport" name="prferncereportfrm" method="post">
                                                                <%
                   if (session.getAttribute("preferncerpt") == "Sucess") {%> 
                                                                <div class="act-success">
                                                                    <span> Report Generated Successfully</span>
                                                                </div>
                                                                <%    session.setAttribute("preferncerpt", null);
                                                                } else if (session.getAttribute("preferncerpt") == "Error") {
                                                                %> 
                                                                    ...
                                                                    <tr style="alignment-adjust: central" >
                                                                        <%
                                                                            try {
                                                                                ...
                                                                                PrefernceDetailsRpt preferncecharmodel = new PrefernceDetailsRpt();
                                                                                barDataset = preferncecharmodel.prefernceBarchart();
                                                                                chart = ChartFactory.createBarChart3D("Candidates Preference Vote Amount Reports by Political Party", "Candidate Name", "Preference Count", barDataset, PlotOrientation.VERTICAL, true, true, false);

                                                                                final File filelocation = new File(getServletContext().getRealPath("") + "/JspPages/Reports/CandidatesPreferenceVoterAmountReportsbyPoliticalParty.png");
                                                                                ChartUtilities.saveChartAsJPEG(filelocation, chart, 600, 600);
                                                                                //Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler D:/Software/JAVA/New folder (2)/images/chart2.jpg");
                                                                                //response.sendRedirect("Adminlogin.jsp");
                                                                                //JFreeChart chart = ChartFactory.createBarChart("Political Parties", "political Party", "Candidates", barDataset, null, true, true, false);
                                                                        ...
                                                                        %>
                                                                    <IMG SRC="../JspPages/Reports/CandidatesPreferenceVoterAmountReportsbyPoliticalParty.png" WIDTH="500" HEIGHT="400" BORDER="0" USEMAP="#chart"> 
                                                                    </tr>
                                                                    <tr>
