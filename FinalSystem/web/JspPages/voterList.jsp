					...
					<div class="span10 col main-right">
						<div class="rrow scroll-y" id="mainYScroller">
							<div class="inner topRight"><ul class="breadcrumb">
                                                                <li><a href="AdminDash.jsp" class="glyphicons home"><i></i> Dash Board </a></li>
	<li class="divider"></li>
	<li>voter Details </li>
</ul><br />
...
<div class="widget widget-gray widget-gray-white">
    <form name="voterloirform" action="../PrintvoterlistServlet" method="post">
        <div class="widget-head">
		<h4 class="heading">Voter Details List</h4>
                <a href="../PrintvoterlistServlet?printdetaisl=All">Print All </a>
	</div>
