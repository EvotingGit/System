							...
							<div class="iScrollWrapper">
								<ul>
									<li class="hasSubmenu2">
										...
										<li class="glyphicons charts currentScroll active"><a href="AddPollingDivisionDetails.jsp" class=""><i></i><span>Create Polling Division</span></a></li>											
...
<table class="table table-bordered tbNormal">
			<thead>
				<tr>
					...
					<th>Polling Code</th>
					<th>Polling Name</th>
                        		<th>Registered Political Parties</th>
                                        <th>Registered Political Voters</th>
                                        <th>District Name</th>
				</tr>
			</thead>
                        <tbody>
