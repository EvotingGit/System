...
<head>
	<title>Polling Division and Provinces</title>
								...
								<ul>
									...
									<li class="hasSubmenu2">
										...
										<li class=""><a href="politicalparydetailRpt.jsp" class="glyphicons show_thumbnails"><i></i><span>Political Party Report</span></a></li>
                                                                                <li class="glyphicons charts currentScroll active"><a href="PollingDivision_Province.jsp" class=""><i></i><span>Polling Division Reports</span></a></li>
										</ul>
									</li>
								</ul>
							</div>
...
<div class="admin_register_wrapper">
   <div class="reg_form_header"><h4>Polling Divisions for Provinces</h4></div>
	  ...
	  <form action="../GenertePollingDivision_Province" name="reportfrm" method="post">
             <table class="admin_reg_tb">
                <tr>
                   <td>                 
                        <div>
                            <label>Select Province Name</label>    
                        </div>
                   </td>
                   <td>
                       <div>
