        ...
        <%
             ...
             pieDataset.setValue("Other", new Integer(25));
                 ...
                 try {
                     ...
                     final File file1 = new File(getServletContext().getRealPath("") + "/JspPages/Reports/piechart.png");
                    ...
                    <div class="row-fluid rrow">
                        ...
                        <div class="span10 col main-right">
                            <div class="rrow scroll-y" id="mainYScroller">
                                ...
                                <!--  our GK start-->
                                <IMG SRC="../JspPages/Reports/piechart.png" WIDTH="600" HEIGHT="400" BORDER="0"
                                     USEMAP="#chart"> 
